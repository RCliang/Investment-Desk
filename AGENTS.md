...
`.Codex/skills/` contains three domain skills relevant to data work: `a-stock-data`, `akshare`, `tushare-api`. They document the same external data sources the backend services wrap — invoke them when extending market/financial data features.
